    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-16">
      ...
      >
        ...
        {linkLabel && linkHref ? (
          <Link
            href={linkHref}
            className="mt-6 inline-flex items-center justify-center rounded-full border border-gray-100 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-gray-600"
          >
            {linkLabel}
          </Link>
        ) : null}
