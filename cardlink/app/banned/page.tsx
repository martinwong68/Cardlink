  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-xl rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
        ...
        <h1 className="mt-3 text-2xl font-semibold text-gray-900">{t("title")}</h1>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link
            href="/auth"
            className="rounded-full border border-gray-100 px-5 py-2 text-sm font-semibold text-gray-700 transition hover:border-indigo-200 hover:text-indigo-700"
          >
            {t("actions.back")}
          </Link>
          <form action={signOut}>
