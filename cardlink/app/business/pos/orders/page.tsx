          ...
          {filtered.map((o) => (
            <div key={o.id} className="rounded-xl border border-gray-100 bg-white p-4">
              <div className="mb-2 flex items-center justify-between">
                <p className="text-sm font-bold text-gray-900">{o.receipt_number}</p>
              ...
              <div className="mb-1 flex justify-between"><span className="text-xs text-gray-500">Tax</span><span className="text-xs text-gray-900">${Number(o.tax_amount).toFixed(2)}</span></div>
