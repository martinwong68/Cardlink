    ...
    <header className="sticky top-0 z-20 border-b border-white/60 bg-white/80 backdrop-blur-xl">
      <div className="app-page flex items-center justify-between py-3">
        ...
        <Link
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full border border-white/80 bg-gradient-to-br from-primary-600 to-primary-600 text-xs font-semibold text-white shadow-lg shadow-primary-300/30"
          aria-label="Profile"
        >
          {profile?.avatar_url ? (
