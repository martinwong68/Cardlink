  ...
  return (
    <div className="space-y-6">
      ...
      <section className="flex flex-wrap gap-2">
        <div className="w-full rounded-2xl border border-neutral-100 bg-white px-3 py-2 text-xs text-neutral-600 shadow-sm">
      ...
      <section className="rounded-2xl border border-neutral-100 bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 space-y-1 rounded-xl border border-neutral-100 bg-neutral-50 px-3 py-3 text-xs text-neutral-600">
        ...
        <button
          ...
          className="mt-4 rounded-full bg-neutral-900 px-4 py-2 text-xs font-semibold text-white disabled:opacity-60"
        >
      ...
      <section className="rounded-2xl border border-neutral-100 bg-white p-5 shadow-sm">
        <h2 className="text-base font-semibold text-neutral-900">{t("sections.addCard.title")}</h2>
        ...
        <div className="mt-4 grid gap-2 sm:grid-cols-2">
          {draft.mode === "existing-member" ? (
            <select
              ...
              className="rounded-xl border border-neutral-100 px-3 py-2 text-sm outline-none ring-primary-300 focus:ring"
            >
          ...
          {draft.mode === "new-account" ? (
            <div className="flex items-center gap-2 rounded-xl border border-neutral-100 px-2 py-2">
              <input
              ...
              <button
                ...
                className="shrink-0 rounded-full border border-neutral-100 px-2 py-1 text-[11px] font-semibold text-neutral-700"
              >
                {t("actions.generate")}
              </button>
            </div>
          ...
          <input
            ...
            className="rounded-xl border border-neutral-100 px-3 py-2 text-sm outline-none ring-primary-300 focus:ring sm:col-span-2"
          />
        </div>
        <button
          type="button"
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-neutral-900">{t("sections.performance.title")}</h2>
        {companyNameCards.length ? (
          companyNameCards.map((card) => {
            ...
            return (
              <article key={card.id} className="rounded-2xl border border-neutral-100 bg-white p-4 shadow-sm">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">{card.card_name || t("labels.untitledCard")}</p>
                    ...
                    <p className="mt-1 text-xs text-neutral-500">{t("labels.views")}: {viewCount} · {t("labels.connections")}: {connectionCount}</p>
                    {card.slug ? (
                      <Link href={`/c/${card.slug}`} className="mt-1 inline-block text-xs text-primary-600 hover:underline">
          ...
          <article className="rounded-2xl border border-neutral-100 bg-white p-5 text-sm text-neutral-600 shadow-sm">
            {t("empty.noCards")}
          </article>
        )}
      </section>
