  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="relative flex h-10 w-10 items-center justify-center rounded-full text-neutral-600 transition hover:text-neutral-900"
      ...
      {open ? (
        <div className="absolute right-0 mt-3 w-80 rounded-xl border border-neutral-100 bg-white shadow-xl md:w-96">
              ...
              notifications.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`flex w-full items-start gap-3 border-t border-neutral-100 px-4 py-3 text-left transition hover:bg-neutral-50 ${
                      isUnread ? "bg-primary-50" : "bg-white"
                    }`}
                  >
                    <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-full bg-primary-600 text-xs font-semibold text-white">
                      {profile?.avatar_url ? (
                        <img
      ...
      {requestModal ? (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-neutral-900/50 px-4 py-6 backdrop-blur-sm md:items-center">
          <div className="w-full max-w-md rounded-t-2xl bg-white p-6 shadow-xl md:rounded-2xl">
            ...
            <div className="mt-4 flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-full bg-primary-600 text-sm font-semibold text-white">
            ...
            <div className="mt-5 flex gap-3">
              <button
                ...
                className="flex flex-1 items-center justify-center gap-2 rounded-full bg-primary-600 px-4 py-3 text-sm font-semibold text-white shadow-lg transition hover:bg-primary-700 disabled:cursor-not-allowed disabled:bg-primary-300"
              >
      ...
      {toast ? (
        <div className="fixed bottom-6 left-1/2 z-50 -translate-x-1/2 rounded-full bg-neutral-900 px-4 py-2 text-xs font-semibold text-white shadow-lg md:bottom-auto md:left-auto md:right-6 md:top-6 md:translate-x-0">
          {toast}
        </div>
      ) : null}
    </div>
