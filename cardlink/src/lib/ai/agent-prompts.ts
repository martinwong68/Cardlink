...
- **inventory / transfer_stock** — params: product_name (string, required), from_warehouse (string, required), to_warehouse (string, required), quantity (number, required)
- **inventory / create_stock_take** — params: warehouse (string, optional), products (array of {product_name, counted_qty}, optional)
- **procurement / create_purchase_order** — params: vendor_name (string, required), items (array of {name, qty, unit_price}, optional), notes (string, optional)
- **procurement / receive_goods** — params: purchase_order_id (string, optional), vendor_name (string, optional — required if no purchase_order_id), total_amount (number, optional), notes (string, optional)
- **procurement / pay_vendor_bill** — params: bill_id (string, optional), vendor_name (string, optional), amount (number, required), payment_method (string, e.g. "bank_transfer","cash"), bill_number (string, optional)
