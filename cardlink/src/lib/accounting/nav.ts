...
export const accountingNavItems: AccountingNavItem[] = [
  ...
  { id: "estimates", href: "/business/accounting/estimates", label: "Estimates", shortLabel: "Estimates" },
  { id: "credit-notes", href: "/business/accounting/credit-notes", label: "Credit Notes", shortLabel: "Credits" },
  ...
  { id: "recurring", href: "/business/accounting/recurring", label: "Recurring", shortLabel: "Recurring" },
  { id: "banking", href: "/business/accounting/banking", label: "Banking", shortLabel: "Banking" },
  { id: "bank-accounts", href: "/business/accounting/bank-accounts", label: "Bank Accounts", shortLabel: "Banks" },
